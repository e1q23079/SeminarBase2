    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['user', 'seminar'],
                name='unique_member_per_seminar'
            )
        ]
...
class Manager(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=['user', 'seminar'],
                name='unique_manager_per_seminar'
            )
        ]
...
def get_seminar_file_path(instance, filename):
    ...
    Args:
        instance (_type_): Fileモデルのインスタンス
        filename (_type_): アップロードされたファイルの元の名前

    Returns:
        _type_: セミナーファイルの保存パス
    """
...
class File(models.Model):
    ...
    file = models.FileField(
        upload_to=get_seminar_file_path,
        verbose_name="ファイル"
    )
