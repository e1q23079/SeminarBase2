...
class Doc:
    def __init__(self, content: str):
        ...
        for lecture in self.lectures:
            lecture['content'] = bleach.clean(lecture['content'], tags = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'br', 'strong', 'em', 'ul', 'ol', 'li', 'code', 'pre', 'table', 'thead', 'tbody', 'tr', 'th', 'td', 'img', 'a'], attributes={'a': ['href', 'title'], 'img': ['src', 'alt']}, strip=True)
