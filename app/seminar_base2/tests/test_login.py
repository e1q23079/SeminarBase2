...
# テスト用のURLパターンを定義
urlpatterns = [
    path('dummy_member/', DummyMemberView.as_view(), name='dummy_member_list'),
    path('dummy_member/<uuid:seminar_id>/', DummyMemberView.as_view(), name='dummy_member_detail'),
    path('dummy_manager/', DummyManagerView.as_view(), name='dummy_manager_list'),
    path('dummy_manager/<uuid:seminar_id>/', DummyManagerView.as_view(), name='dummy_manager_detail'),
]
...
class LoginMemberRequiredMixinTests(TestCase):
    ...
    def setUp(self):
        ...
        # セミナーを作成
        self.seminar = Seminar.objects.create(title='Test Seminar', content='Test Content', public=True)
